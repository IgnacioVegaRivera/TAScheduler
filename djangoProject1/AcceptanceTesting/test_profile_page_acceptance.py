...
class TestProfilePageAcceptance(TestCase):
    def setUp(self):
        ...
        self.adminUno = User.objects.create(first_name="Ad", last_name="User", username="admin", password="password",
            role="Admin", email="admin@uwm.edu",phone_number=1213439090, skills="None", address="709 Big Boy Lane")
        self.instructorUno = User.objects.create(first_name="Instruct", last_name="User", username="instructor",
            password="password", role="Instructor", email="instructor@uwm.edu", phone_number=1415458080,
            skills="Data Structors, C, and Java", address="313 Llama Rd.")
        self.taUno = User.objects.create(first_name="Ta", last_name="User", username="ta", password="password" , role="TA",
            email="ta@uwm.edu", phone_number=1615959090, skills="Python, AI, and JavaScript", address="907 Chicken Ct.")
        self.adminUno.save()
